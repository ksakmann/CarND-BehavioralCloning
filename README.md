...
edit 23-12-2016: the performance of the same CNN on the trainig track can be seen here. Note that the car successfully recovers from critical situations, even though no recovery events were recorded. All recovery events were generated by distorting the images as described above.
